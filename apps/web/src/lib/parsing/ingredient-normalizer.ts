...
const COOKING_STOP_WORDS = new Set([
  // Preparation verbs
  'chopped', 'diced', 'sliced', 'minced', 'peeled', 'cored',
  'grated', 'crushed', 'ground', 'smashed', 'julienned',
  'finely', 'roughly', 'coarsely', 'thinly', 'cubed', 'quartered',
  'halved', 'shredded', 'torn', 'pounded', 'trimmed', 'deveined',
  'seeded', 'pitted', 'zested', 'squeezed', 'pressed', 'mashed',

  // State adjectives
  'fresh', 'dried', 'frozen', 'thawed', 'melted', 'softened',
  'warm', 'cold', 'hot', 'raw', 'cooked', 'roasted', 'toasted',
  'sauteed', 'fried', 'baked', 'grilled', 'steamed', 'blanched',
  'chilled', 'room', 'temperature', 'ripe', 'unripe', 'rinsed',
  'drained', 'patted', 'dry',

  // Quality/size adjectives
  'organic', 'large', 'medium', 'small', 'extra', 'virgin',
  'gluten', 'free', 'kosher', 'boneless', 'skinless', 'lean',
  'thick', 'thin', 'good', 'quality', 'packed', 'heaping',
  'rounded', 'level', 'scant', 'generous', 'homemade', 'store',
  'bought', 'low', 'sodium', 'reduced', 'fat', 'nonfat', 'whole',

  // Connectives and common words
  'of', 'in', 'with', 'for', 'to', 'or', 'and', 'the', 'a', 'an',
  'about', 'approximately', 'plus', 'more', 'as', 'needed', 'optional',
  'if', 'desired', 'taste', 'serving', 'each', 'such',
  ...
  'lb', 'lbs', 'gram', 'grams', 'g', 'kilogram', 'kg', 'ml',
  'milliliter', 'liter', 'liters', 'l', 'quart', 'quarts', 'qt',
  'pint', 'pints', 'pt', 'gallon', 'gallons', 'gal', 'pinch',
  'dash', 'bunch', 'bunches', 'head', 'heads', 'clove', 'cloves',
  'stalk', 'stalks', 'sprig', 'sprigs', 'can', 'cans', 'jar', 'jars',
...
export function keysMatch(
  ...
  const hasSharedToken =
    tokens1.some((t1) => tokens2.includes(t1)) ||
    tokens2.some((t2) => tokens1.includes(t2));
