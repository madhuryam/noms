...
export function ImportPreview({
  ...
  const { selectedCount, warningCount, errorCount, needsFormattingCount, duplicateCount } = useMemo(() => {
    let selected = 0;
    let warnings = 0;
    let errors = 0;
  ...
  }, [isDirty, isTitleDirty, selectedRecipe, saveCurrentChanges, onSelectionChange, onStartImport, result.recipes]);
