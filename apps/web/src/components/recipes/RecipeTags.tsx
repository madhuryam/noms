    ...
    <div className="flex flex-wrap gap-2">
      ...
      {categories.map((category, index) => (
        <Link
          ...
          className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium transition-opacity hover:opacity-80 bg-gray-100 text-gray-700 dark:bg-onedark-bg-highlight dark:text-onedark-fg`}
        >
