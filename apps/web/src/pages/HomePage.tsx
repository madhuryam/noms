    ...
    <div className="space-y-8">
        ...
        >
          <div className="flex items-center gap-4">
            <div className="p-3 bg-blue-50 dark:bg-onedark-blue/10 rounded-lg group-hover:bg-blue-100 dark:group-hover:bg-onedark-blue/20 transition-colors">
              <svg className="w-6 h-6 text-blue-600 dark:text-onedark-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-onedark-fg-muted">View all your recipes</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            <div className="p-3 bg-green-50 dark:bg-onedark-green/10 rounded-lg group-hover:bg-green-100 dark:group-hover:bg-onedark-green/20 transition-colors">
              <svg className="w-6 h-6 text-green-600 dark:text-onedark-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-onedark-fg">Meal Plans</h3>
              <p className="text-sm text-gray-500 dark:text-onedark-fg-muted">Plan your weekly meals</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            <div className="p-3 bg-purple-50 dark:bg-onedark-purple/10 rounded-lg group-hover:bg-purple-100 dark:group-hover:bg-onedark-purple/20 transition-colors">
              <svg className="w-6 h-6 text-purple-600 dark:text-onedark-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
              </svg>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-onedark-fg">Pantry</h3>
              <p className="text-sm text-gray-500 dark:text-onedark-fg-muted">Track your ingredients</p>
            </div>
          </div>
        </Link>
      </section>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-onedark-fg">Recent Recipes</h2>
          <Link
            to="/recipes"
        ...
        <div className="bg-white dark:bg-onedark-bg-lighter rounded-xl border border-gray-200 dark:border-onedark-bg-highlight p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-onedark-fg-muted">No recipes yet. Add your first recipe to get started!</p>
        </div>
      </section>
    </div>
  );
