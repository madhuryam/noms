    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 dark:text-onedark-fg-muted">Track your available ingredients</p>
        </div>
      ...
      <div className="bg-white dark:bg-onedark-bg-lighter rounded-xl border border-gray-200 dark:border-onedark-bg-highlight p-12 text-center">
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-onedark-fg mb-2">Pantry is empty</h3>
